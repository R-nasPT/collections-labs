...
const buttonVariants = cva("p-1 rounded-md transition-smooth", {
  variants: {
    colorScheme: {
      ...
      "outline-green": "text-green-500 border border-green-500 hover:bg-green-50 disabled:text-green-300 disabled:border-green-300 disabled:bg-transparent",
      red: "bg-red-500 hover:bg-red-600 text-white disabled:bg-red-300",
      "outline-red": "text-[#d32f2f] border border-[#d32f2f] hover:bg-[#faf1f1] disabled:text-red-300 disabled:border-red-300 disabled:bg-transparent",
      purple: "bg-purple-600 hover:bg-purple-700 text-white disabled:bg-purple-300",
      "outline-purple": "text-purple-600 border border-purple-600 hover:bg-purple-50 disabled:text-[#bca7e6] disabled:border-[#e4d7ff] disabled:bg-transparent",
      ...
      "outline-cyan": "border border-[#1fc7d4] text-[#1fc7d4] hover:bg-[#e6fafb] disabled:text-[#a7e8ed] disabled:border-[#a7e8ed] disabled:bg-transparent",
      blue: "bg-blue-500 hover:bg-blue-600 text-white disabled:bg-blue-300",
      "outline-blue": "border border-blue-500 text-blue-500 hover:bg-blue-50 disabled:border-blue-300 disabled:text-blue-300 disabled:bg-transparent",
